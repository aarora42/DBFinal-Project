        ...
        <div>
            {
                ...
                <div className="row">
                    ...
                    <div className="col-1">
                        <Link to={`/artists/${artistCopy.idArtist}/albums`}>
                            Albums
                        </Link>
                    </div>
                    <div className="col-2">
                        <i className="fas fa-2x fa-check float-right margin-left-10px"
                           onClick={() => {
                               setEditing(false)
                               updateArtist(artistCopy.idArtist, artistCopy)
                           }}></i>
                        <i className="fas fa-2x fa-undo float-right margin-left-10px"
                           onClick={() => setEditing(false)}></i>
                        <i className="fas fa-2x fa-trash float-right margin-left-10px"
                           onClick={() => deleteArtist(artist.idArtist)}></i>
                    </div>
                </div>
            }
            {
                ...
                <div className="row">
                    <div className="col">
                        <Link to={`/artists/${artistCopy.idArtist}`}>
